  ...
  return (
    <View
      ...
      <View style={{ alignItems: 'center', justifyContent: 'center' }}>
        ...
        <TextInput onChangeText={(text) => setMessage1(text)} style={{ borderWidth: 2, width: '100%', height: 40 }} />
        <TextInput onChangeText={(text) => setMessage2(text)} style={{ borderWidth: 2, width: '100%', height: 40 }} />
      <Button
